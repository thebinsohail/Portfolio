...
class Accomp extends Component {
    ...
    render() {
      ...
      <Col lg="4" md="6" sm="12" style={{}}>
        <Card body id="rows" className="dib br3 pa3 ma1">
      ...
      <Col lg="4" md="6" sm="12" style={{}}>
        <Card body id="rows"  className="dib br3 pa1 ma1" >
      ...
      <Col lg="4" md="6" sm="4" >
        <Card body id="rows"  className="dib br3 pa1 ma2">
      ...
      <Col lg="4" md="2" sm="8">
        <Card body id="row3"  className="dib br3 pa1 ma2">
